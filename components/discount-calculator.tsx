                            ...
                            <div className="space-y-6 pt-2">
                              ...
                              <div className="space-y-3">
                                <div className="flex items-center gap-2">
                                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 font-bold">20% + VAT</Badge>
                                  <h4 className="font-bold text-slate-900 text-base md:text-lg">Restaurant & Services</h4>
                                </div>
                                <ul className="space-y-2 text-sm md:text-base text-slate-700">
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Hotels, restaurants, and recreation centers</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Theaters, cinema houses, concert halls</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Medicines and drugstores</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Medical and dental services (diagnostic, lab fees, professional fees)</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Domestic air and sea travel</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Land transportation (Jeepneys, Buses, Taxis, Trains)</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-blue-600 mt-1">•</span>
                                    <span>Funeral and burial services</span>
                                  </li>
                                </ul>
                              </div>
                              ...
                              <div className="space-y-3">
                                <div className="flex items-center gap-2">
                                  <Badge className="bg-green-100 text-green-700 hover:bg-green-100 font-bold">5%</Badge>
                                  <h4 className="font-bold text-slate-900 text-base md:text-lg">Groceries (Capped at ₱2,500/week)</h4>
                                </div>
                                <ul className="space-y-2 text-sm md:text-base text-slate-700">
                                  <li className="flex items-start gap-2">
                                    <span className="text-green-600 mt-1">•</span>
                                    <span>Basic necessities (Rice, bread, milk, coffee, laundry soap, etc.)</span>
                                  </li>
                                  <li className="flex items-start gap-2">
                                    <span className="text-green-600 mt-1">•</span>
                                    <span>Prime commodities (Fresh fruits, flour, canned goods, etc.)</span>
                                  </li>
                                </ul>
                                <div className="p-3 rounded-lg bg-red-50 border-l-4 border-red-500">
                                  <p className="text-sm md:text-base text-red-800 font-semibold">
                                    <strong>No VAT discount</strong> except for agricultural/marine products in original state
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  <Badge variant="outline" className="text-xs md:text-sm">RA 10754</Badge>
                                  <Badge variant="outline" className="text-xs md:text-sm">RA 9994</Badge>
                                  <Badge variant="outline" className="text-xs md:text-sm">RA 7581</Badge>
                                  <Badge variant="outline" className="text-xs md:text-sm">JMC 01-2022</Badge>
                                  <Badge variant="outline" className="text-xs md:text-sm">RR 5-2017</Badge>
                                  <Badge variant="outline" className="text-xs md:text-sm">DOJ Opinion 45-2024</Badge>
                                </div>
                                <a
                                  href="https://www.officialgazette.gov.ph/2016/03/23/republic-act-no-10754/"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold text-sm md:text-base group"
                                >
